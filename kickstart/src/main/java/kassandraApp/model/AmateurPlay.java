...
@Entity
public class AmateurPlay extends Event{
	
	@Deprecated
	protected AmateurPlay(){}
	
	public AmateurPlay(String name, long price, Room room){
		super(name, price);
		this.setRoom(room);
	}
	...
	public void addAppointment(int beginYear, int beginMonth, int beginDay, int beginHour, int beginMinute, int endYear, int endMonth, int endDay, int endHour, int endMinute, boolean premiere, boolean rehearsal) {
		super.getAppointments().add(new Appointment(beginYear, beginMonth, beginDay, beginHour, beginMinute, endYear, endMonth, endDay, endHour, endMinute, super.getSeats(), premiere, rehearsal));
	}
